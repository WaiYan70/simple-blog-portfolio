...
export const LinkedInIcon = ({ size = 16, className }: LinkedInIconProps) => {
  return (
    ...
    >
      ...
      <path d="M69.925,29.383c-9.382,0-15.673,5.144-18.248,10.022h-0.258v-8.479H32.921v62.053h19.27V62.281c0-8.093,1.541-15.932,11.575-15.932c9.89,0,10.022,9.256,10.022,16.451v30.178H93.06V58.942C93.06,42.235,89.455,29.383,69.925,29.383z" />
    </svg>
  );
};
